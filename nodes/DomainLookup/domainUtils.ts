...
export const DOMAIN_LOOKUP_ERROR_CODES = {
	...
	RDAP_BOOTSTRAP_UNAVAILABLE: 'RDAP_BOOTSTRAP_UNAVAILABLE',
	RDAP_SOURCE_UNAVAILABLE: 'RDAP_SOURCE_UNAVAILABLE',
	RDAP_RESPONSE_PARSE_FAILED: 'RDAP_RESPONSE_PARSE_FAILED',
	TLD_NOT_SUPPORTED: 'TLD_NOT_SUPPORTED',
	WHOIS_SOURCE_UNAVAILABLE: 'WHOIS_SOURCE_UNAVAILABLE',
	WHOIS_RATE_LIMITED: 'WHOIS_RATE_LIMITED',
	WHOIS_RESPONSE_PARSE_FAILED: 'WHOIS_RESPONSE_PARSE_FAILED',
	CNNIC_WHOIS_UNAVAILABLE: 'CNNIC_WHOIS_UNAVAILABLE',
	CNNIC_WHOIS_RATE_LIMITED: 'CNNIC_WHOIS_RATE_LIMITED',
	CNNIC_WHOIS_RESPONSE_PARSE_FAILED: 'CNNIC_WHOIS_RESPONSE_PARSE_FAILED',
} as const;
